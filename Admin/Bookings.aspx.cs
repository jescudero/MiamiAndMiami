...
public partial class Admin_Bookings : System.Web.UI.Page
{
    ...
    protected void SelectData()
    {
        ...
        this.cmd = new MySqlCommand("SELECT * FROM Bookings Where Type='" + ddlGuestType.Text + "'  Order By BookingDate DESC ", this.con);
        //this.cmd = new MySqlCommand("SELECT * FROM Bookings Where Type='" + ddlGuestType.Text + "' And (BookingDate Between '" + ArrivalDate + "' And '" + DepartureDate + "') Order By BookingDate DESC ", this.con);
    ...
    protected void LnkDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in this.GrdServiceProviders.Rows)
        {
            ...
            if (flag)
            {
                ...
                this.cmd = new MySqlCommand("delete from Bookings where Bookingkey='" + HotelReviewKey + "' ", this.con);
