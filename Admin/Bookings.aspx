<%@ Page Title="Bookings" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Bookings.aspx.cs" Inherits="Admin_Bookings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" Runat="Server">
   <script type="text/javascript" >
       ...
       function fnConfirmDeletion() {
           ...
           var r = confirm("Are you sure you want to delete this Bookings ?");
           if (r == true) {
               return true;
           }
           else {
 ...
 <script type="text/javascript" language="javascript">
     ...
     <script type="text/javascript" language="javascript">
         function fnSelect() {
             ...
             if (tt == 0) {
                 alert("please select the Bookings");
                 return false;
             }
             else {
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="page-title1" ><h2>Bookings</h2></div>
         ...
         <asp:HiddenField ID="HiddenField2" runat="server" />                 
            ...
            <asp:LinkButton runat="server" ID="LinkButton1" Text="Cancel"
                OnClick="hideModalPopupViaServer1_Click" />
                 ...
                 <label style="font-size:14px;font-weight:bold">View Bookings by:</label>&nbsp;&nbsp;
...
<div id="Planning-tools"  style="margin-top:10px;" >
    ...
    <Columns>
     ...
     <asp:TemplateField HeaderText="HotelReviewKey" Visible="False"  >
      <ItemTemplate>       
      <asp:LinkButton ID="lnkUserKey" Visible="true" runat="server" Text='<%#Eval("Bookingkey")%>' CommandName="Select"></asp:LinkButton>
      </ItemTemplate>     
      </asp:TemplateField>
      ...
      <asp:LinkButton ID="lnkUserKey1" Visible="true" runat="server" Text='<%#Eval("HotelKey")%>' CommandName="Select"></asp:LinkButton>
       ...
       <HeaderTemplate >
        ...
        <asp:TemplateField HeaderText="Booking Date"  HeaderStyle-Width="80px" >
      <ItemTemplate>              
              <asp:Label ID="lblBookingDate" Visible="true" runat="server" Text='<%#Eval("BookingDate","{0:dd-MMM-yyyy}" )%>'></asp:Label>              
      </ItemTemplate>     
      </asp:TemplateField>
      ...
      <ItemTemplate>
              <asp:Label ID="lblRating" Visible="true" runat="server" Text='<%#Eval("TravalingCity")%>'></asp:Label>              
      </ItemTemplate>     
      </asp:TemplateField>
      ...
      <ItemTemplate> 
      <a id ="example2" href="Booking.aspx?BookingID=<%#Eval("Bookingkey")%>" onclick="return hs.htmlExpand( this, { objectType: 'iframe', outlineType: 'glossy-dark', wrapperClassName: 'highslide-wrapper drag-header', outlineWhileAnimating: true, preserveContent: false, width: 500 } )" >View</a>
             </ItemTemplate>     
      </asp:TemplateField> 
