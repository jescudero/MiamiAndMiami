...
public partial class Admin_Enquiries : System.Web.UI.Page
{
    ...
    protected void SelectData()
    {
        ...
        this.cmd = new MySqlCommand("SELECT * FROM Enquiries Where Type='" + ddlGuestType.Text + "'   Order By EnquiryDate DESC ", this.con);
        //this.cmd = new MySqlCommand("SELECT * FROM Enquiries Where Type='" + ddlGuestType.Text + "'  And (EnquiryDate Between '" + ArrivalDate + "' And '" + DepartureDate + "')  Order By EnquiryDate DESC ", this.con);
    ...
    protected void LnkDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in this.GrdServiceProviders.Rows)
        {
            ...
            if (flag)
            {
                ...
                this.cmd = new MySqlCommand("delete from Enquiries where Enquirykey='" + HotelReviewKey + "' ", this.con);
