<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="PackageGalleries.aspx.cs" Inherits="Admin_PackageGalleries" Title="Package Galleries" %>
...
url="DeletePackagePhoto.aspx?id1="+abcd+"&PackageID="+ HotelID;
...
<h5>
    <asp:Label ID="Label1" runat="server" Text="Package Photos (0)"></asp:Label></h5>
    <br />
...
<img style=" padding:1px; margin:1px; cursor:pointer; width:100px; height:100px;  -moz-box-shadow:#999 2px 0px 5px;  -webkit-box-shadow:#999 2px 0px 5px;" src="../Packages/<%#Eval("ImageName")%>"  alt="" />
<br />  <a id ="A2" href="#" onclick="return fnconfirm(<%#Eval("PackagePhotoKey")%>, <%#Eval("PackageKey")%>)" title="Remove" >Remove </a> </li>
</ItemTemplate>
<EmptyItemTemplate>
<div>
